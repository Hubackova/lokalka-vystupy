...
const AutosuggestContainer = ({ ...props }) => {
  ...
  const renderSuggestion = suggestion => <div name={suggestion.title} grade={suggestion.grade} subregion={suggestion.subRegion} region={suggestion.region}>{suggestion.title} / {suggestion.grade} / {suggestion.subRegion} / {suggestion.region}</div>
